...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Prescription.create': {
    roles: ['pharmacist', 'business-owner'],
    key: 'prescriptionId',
    tenantPath: [],
    userPath: [],
  },
  'Prescription.update': {
    roles: ['pharmacy-manager', 'business-owner'],
    key: 'prescriptionId',
    tenantPath: [],
    userPath: [],
  },
  'Branch.create': { roles: ['pharmacy-manager', 'pharmacist'], key: 'branchId', tenantPath: [], userPath: [] },
};

const ownerRoles: string[] = ['pharmacist'];
const customerRoles: string[] = [];
const tenantRoles: string[] = ['business-owner', 'pharmacy-manager', 'pharmacist'];
