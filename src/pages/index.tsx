...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`Online Pharmacy App v1`}</title>

        <meta
          name="description"
          content="Welcome to PharmaOne, your trusted Online Pharmacy App v1. Offering a wide range of pharmaceutical and healthcare products with an attractive FLAT 10% OFF. Experience the convenience of online pharmacy, today."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            <Heading mb={{ base: '12px', lg: '20px' }} size="2xl">
              {`Online Pharmacy App v1`}
            </Heading>
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to PharmaOne, your trusted Online Pharmacy App v1. Offering a wide range of pharmaceutical and healthcare products with an attractive FLAT 10% OFF. Experience the convenience of online pharmacy, today.`}
            </Text>
            <Box
